...
[tennis_image]: https://video.udacity-data.com/topher/2018/May/5af7955a_tennis/tennis.png ("Unity ML-Agents Tennis Environment")
...
[![Tennis](Tennis_thumbnail.jpg)](https://www.youtube.com/watch?v=kxDvrkg8ep0&feature=emb_logo)
...
### Usage
Navigate to the Tennis.ipynb file and follow the instructions and read the code to learn about the enviroment, agent, train the agent, and test it. We train our agent to achieve a moving average score of 0.65 instead of the required 0.5.